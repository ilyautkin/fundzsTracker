...
fundzsTracker is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/fundzsTracker.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory fundzsTracker is now in, and do this:
...
Now, you'll want to change references to fundzsTracker in the files in your
new copied-from-fundzsTracker repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'fundzsTracker' to whatever the
name of your component is.

## Copyright Information

fundzsTracker is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of fundzsTracker the ability to modify, distribute
and use fundzsTracker in MODx development as they see fit, as long as attribution
